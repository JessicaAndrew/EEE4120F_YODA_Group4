...
g = open("OutEdgeGoldenSpeed.txt", "r") # open file that holds golden speed
...
f = open("OutEdgeOpenCLSpeed.txt", "r") # open file that holds OpenCL speed
...
print("Speed up of OpenCL to golden of edge dectection (without overhead): " + str(calc))
calc = speedGolden/(speedOpenCl+overheadOpenCl)
print("Speed up of OpenCL to golden of edge dectection (with overhead): " + str(calc))